...
% \setcounter{secnumdepth}{2} % độ sâu đánh số mục lục. 1 là section, 2 là subsubsection, 3 là paragraph
...
%
\input{chapters/chapter1-dannhap.tex}
\input{chapters/document-preparation.tex}
...
% \bibliographystyle{plainnat} % Phân loại theo ABC (tên tác giả)
% \bibliography{refs}
% \printbibliography[language=english, title={English References}]
